  ...
  function Slider() {
    ...
    _this.dragFromSVG = function (e) {
      if (!_this.state.dragging) {
        ...
        var selected = _this.props.scale.invert(e.clientX - _this.svg.getBoundingClientRect().left);
        var dragIndex = 2;
    ...
    _this.mouseMove = function (e) {
      if (_this.state.dragging) {
        var selection = [].concat(_toConsumableArray(_this.props.selection));
        var pos = _this.props.scale.invert(e.clientX - _this.svg.getBoundingClientRect().left);
